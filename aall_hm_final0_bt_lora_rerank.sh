...
for i in {31..31}; do
[REDACTED]
    log_dir="./rerank_logs/bt_lora_800each_topk75_topr50_rerank/bt_800each_router${i}_logs"
    output_dir="./rerank_results/bt_lora_800each_router${i}_topk75_topr50_rerank"
