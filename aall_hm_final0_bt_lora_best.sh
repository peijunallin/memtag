...
for i in {31..31}; do
[REDACTED]
    log_dir="./best1_logs/bt_lora_800each_topk${top_k}/bt_800each_router${i}_topk${top_k}_soft3"
    output_dir="./best1_results/bt_lora_800each_router${i}_results_topk${top_k}_soft3"
