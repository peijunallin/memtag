...
for i in {31..31}; do
[REDACTED]
    log_dir="./best1_logs/rerank_bt_800each_router${i}_topk${top_k}_topr${top_r}_soft3"
    output_dir="./best1_results/rerank_bt_lora_800each_router${i}_results_topk${top_k}_topr${top_r}_soft3"
