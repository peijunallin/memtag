...
for i in {31..31}; do
[REDACTED]
    log_dir="./iter_logs/bt_lora_800each_topk50_topt50_iter_n3/bt_300each_router${i}_logs"
    output_dir="./iter_results/bt_lora_800each_router${i}_topk50_topt50_iter_n3"
