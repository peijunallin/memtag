...
[REDACTED]
ablation_type="memory_units_with_top_k_with_rerank_top_r"
top_k=75
top_r=50  # set top_r > 0 for reranking
top_s=0
top_t=25
num_turns=4
answer_with_memory_units=1
use_iterative_retrieval=0  # disable iterative retrieval
...
gpu_id="0"
log_dir="./logs/baseline_rerank_topr${top_r}_topk${top_k}"
output_dir="./baseline_rerank_results_topr${top_r}_topk${top_k}"
