...
for i in {1..20}; do
    ...
    log_dir="./logs/nodedeup_logs/hm_router${i}_logs"
    output_dir="./nodedup_results/hm_router${i}_results"
...
[REDACTED]
        ...
        CUDA_VISIBLE_DEVICES=$gpu_id python run_readers_hm_router_v0_nodedup_refine.py \
            --dataset "$dataset" \
